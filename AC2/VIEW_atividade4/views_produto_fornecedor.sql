...
CREATE TABLE `produto_fornecedor` (
  ...
  KEY `forn_id` (`forn_id`),
  CONSTRAINT `produto_fornecedor_ibfk_1` FOREIGN KEY (`prod_id`) REFERENCES `produtos` (`id`),
  CONSTRAINT `produto_fornecedor_ibfk_2` FOREIGN KEY (`forn_id`) REFERENCES `fornecedores` (`id`)
